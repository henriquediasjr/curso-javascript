...
const maskCreditCard = function (number) {
  const str = number + ''; // quando um dos elementos que vai ser adicionado for uma string entao o resultado todo vai ser uma string
  const last = str.slice(-4);
  return last.padStart(str.length, '*');
};
console.log(maskCreditCard(23461446432456246));
console.log(maskCreditCard('34234253521352353'));
